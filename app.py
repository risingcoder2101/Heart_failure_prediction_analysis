...
This app predicts the likelihood of a person having an **HEART❤️ ATTACK** .
...
st.header('**Upload a File, or Use the Sliders and Select boxes by the left.**')
...
uploaded_file = st.sidebar.file_uploader("UPLOAD YOUR DETAILS FILE HERE IN CORRECT FORMAT", type = ['csv'])
...
try:
    ...
    def user_input_features():
        age = st.sidebar.slider('What is your Age?',16,100,40)
